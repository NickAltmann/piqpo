...
{    
    ...
    private function createCommand( $command )
    {
        ...
        {
            $apiCommand = new APIGetProfileSlides();
        }
        ...
        elseif ($command == 'getUserSlides')
        {
            $apiCommand = new APIGetUserSlides();
        }
        elseif ($command == 'getStreamSlides')
        {
            $apiCommand = new APIGetStreamSlides();
        }
    ...
    {
        return $this->createCommandArray( array( "hello", "createAccount", "logIn", "logOut", "resetPassword", "getDeviceSlides", "getProfileSlides", "activateProfile", "getStreamSlides" ) );
    }
    
    // Returns an array of all user commands
    public function getUserCommands()
    {
        return $this->createCommandArray( array( "changeEmail", "changePassword", "userStreams", "availableStreams", "subscribeToStream", "unsubscribeFromStream", "addDevice", "getUserDetails", "getUserSlides" ) );
    }
