...
class Feed
{
	...
	public static function processDBQuery( $queryString )
	{
		...
		while ($myrow = mysql_fetch_array($result))
		{
			...
			$output[] = new Feed($feedId,$feedDefinitionFile,$name,$pause,$pollFrequency,$templateFile,$maxSlides);
		}
		return $output;
	}

	public static function create($feedDefinitionFile,$name,$pause,$pollFrequency,$templateFile,$maxSlides)
	{
		$db = new DBManager("piqpo");
		$fields=array();
	...
	public function update($feedDefinitionFile,$name,$pause,$pollFrequency,$templateFile,$maxSlides)
	{
		$db = new DBManager("piqpo");
		$fields=array();
		$nullableFields=array();
	...
	function Feed($feedId,$feedDefinitionFile,$name,$pause,$pollFrequency,$templateFile,$maxSlides)
	{
		$this->_feedId = $feedId;
